...
const float MAX_THROTTLE = 1450.0;
const float MIN_THROTTLE = 1300.0;
const float THROTTLE_OFF = 1000.0;
...
void loop()
{
    ...
    // to ppm
    long flighttime = millis() - jefftime;
    Serial.print(flighttime);
    Serial.print(" : ");
    Serial.println(calc_throttle(flighttime));
    
    
    ppm[0]=calc_throttle(flighttime);
    ppm[1]=1500;
    ppm[2]=1500;
    ppm[3]=1500;
...
int calc_throttle(long flightMillis)
{ 
